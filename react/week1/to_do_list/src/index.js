...
function ListMaker(props){
  console.log(props)
  const listoftask = props.mytasks.map( task =>{
    return( <p> <font color = {task.color} > The task named "{task.title}" should be finished before <strong>"{task.dealline}"</strong></font> </p>);
  })
